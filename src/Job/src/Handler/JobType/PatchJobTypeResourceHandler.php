...
use Api\Job\InputFilter\EditJobTypeInputFilter;
...
class PatchJobTypeResourceHandler extends AbstractHandler
{
    #[Inject(
        JobTypeServiceInterface::class,
        EditJobTypeInputFilter::class,
    )]
    public function __construct(
        protected JobTypeServiceInterface $jobTypeService,
        protected EditJobTypeInputFilter $inputFilter,
    ) {
    }
